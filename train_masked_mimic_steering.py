#!/usr/bin/env python3
"""
Training script for Masked Mimic Agent in Steering Environment

This script trains a masked mimic agent to perform steering tasks using a pretrained
expert model as demonstration data. The agent learns to follow directional commands
and speed targets while maintaining natural motion quality.

Usage:
    python train_masked_mimic_steering.py [options]

Options:
    --experiment_name: Name for the experiment (default: masked_mimic_steering_training)
...
def main():
    parser = argparse.ArgumentParser(description="Train Masked Mimic Agent in Steering Environment")
    parser.add_argument("--experiment_name", type=str, default="masked_mimic_steering_training",
