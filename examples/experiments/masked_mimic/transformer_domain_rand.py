...
def agent_config(
    ...
    trunk_config = SequentialModuleConfig(
        in_keys=["reduced_coords_obs", "historical_previous_actions", "vae_latent"],
...
def apply_inference_overrides(
    ...
    # Reuse the mimic apply_inference_overrides function from mimic.mlp_deploy
    ...
    env_cfg.motion_manager.realign_motion_with_humanoid_on_each_step = False
