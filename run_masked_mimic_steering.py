#!/usr/bin/env python3
"""
Script to run masked mimic agent in steering environment.
"""
...
def run_masked_mimic_steering(checkpoint_path, robot="smpl", simulator="isaaclab"):
    """
    Run masked mimic agent in steering environment.
...
def main():
    ...
    print("Running Masked Mimic Agent in Steering Environment")
    print("=" * 60)
    ...
    # Run the evaluation
    success = run_masked_mimic_steering(checkpoint_path, robot, simulator)
